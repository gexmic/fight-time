...
namespace GEX
{
		...
		_statsText()
	{
		...
		TextureHolder::getInstance().load(TextureID::DessertTileOne,        "../Media/Textures/1.png");
		TextureHolder::getInstance().load(TextureID::DessertTileTwo,		"../Media/Textures/2.png");
